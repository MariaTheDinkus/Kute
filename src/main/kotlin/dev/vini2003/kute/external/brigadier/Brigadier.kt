package dev.vini2003.kute.external.brigadier
...
data class CommandSource(val discord: GatewayDiscordClient, val youtube: YoutubeClient, val spotify: SpotifyApi, val user: User, val message: Message)
